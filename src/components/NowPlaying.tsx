...
export const NowPlaying = () => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center p-4 bg-slate-800/50 rounded-lg border border-slate-700/50">
  ...
  if (!spotify) {
    return (
      <div className="bg-slate-800/50 border border-slate-700/50 rounded-lg p-4 shadow-xl backdrop-blur-sm">
